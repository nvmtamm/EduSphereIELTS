    ...
    <div className="space-y-8 max-w-7xl mx-auto pb-16">
        ...
        <div className="relative z-10 max-w-3xl space-y-3">
          ...
          <div className="flex items-center gap-3 pt-2 flex-wrap">
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-white text-zinc-950 hover:bg-zinc-100 font-bold text-xs shadow-lg flex items-center gap-2 transition-all hover:scale-[1.02]"
            >
      ...
      <div className="flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800 pb-2 flex-wrap gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => setIsUploadModalOpen(true)}
            className="px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white text-xs font-bold rounded-xl shadow-md shadow-purple-600/20 flex items-center gap-2 transition-colors"
          >
        ...
        <div className="space-y-6">
          ...
          {loadingPassages ? (
            ...
            <div className="text-center py-20 bg-white dark:bg-zinc-950 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-8">
              ...
              <button
                onClick={() => setIsUploadModalOpen(true)}
                className="mt-4 px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white text-xs font-bold rounded-xl shadow-md transition-colors"
              >
                Upload Passage with AI Agent
              </button>
            </div>
          ) : (
                ...
                >
                  ...
                  <div className="pt-4 mt-4 border-t border-zinc-100 dark:border-zinc-800/80 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-3.5 py-1.5 bg-red-600 hover:bg-red-500 text-white text-xs font-bold rounded-xl shadow-sm flex items-center gap-1.5 transition-transform hover:scale-105"
                    >
